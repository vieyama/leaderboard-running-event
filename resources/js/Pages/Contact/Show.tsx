        ...
        <GuestLayout>
            ...
            <div className="py-20 text-white bg-gradient-to-r from-blue-600 to-blue-800">
                <div className="container px-4 pt-12 mx-auto text-center">
                    <h1 className="mb-4 text-3xl font-bold md:text-3xl">Contact Us</h1>
                    <p className="mx-auto max-w-3xl text-md md:text-lg">
            ...
            <div className="container px-4 py-16 mx-auto">
                <div className="grid-cols-1 gap-8 mx-auto max-w-4xl md:grid-cols-2 md:grid">
                    {/* WhatsApp 1 */}
                    {settings.whatsapp1 && (
                        <div className="p-8 text-center bg-white rounded-lg shadow-lg hover:shadow-xl">
                            ...
                            <p className="text-gray-600">
                                <a 
                                    ...
                                    className="flex gap-2 justify-center items-center transition-colors hover:text-green-600"
                                >
                ...
                {/* Email */}
                {settings.email && (
                    <div className="p-8 mx-auto mt-8 max-w-2xl text-center bg-white rounded-lg shadow-lg hover:shadow-xl">
                        <div className="flex justify-center items-center mx-auto mb-6 w-16 h-16 bg-blue-100 rounded-full">
                            <Mail className="w-8 h-8 text-blue-600" />
                        </div>
                        <h3 className="mb-2 text-xl font-semibold">{settings.email_label || 'Email Us'}</h3>
                        <p className="text-gray-600">
                            <a 
